...
const FacetedValues = (props: Props) => {
	...
	React.useEffect(() => {
        // let test = theTable.setColumnFilters([{id: 'email', value: 'dlamberteschi4@bloomberg.com'}]);
        // console.log('theTable', theTable);

		// let main = theTable.getAllColumns().map((col: any)=> {
		// 	console.log('============================');
		// 	console.log('col', col);
		// 	let test = col?.accessorFn();
		// 	console.log("test: ", test);

        //     // console.log('col accessorFn', col?.accessorFn())
	...
	React.useEffect(() => {
		let foo = theTable.getGlobalFacetedUniqueValues();
		console.log("foo: ", foo);
